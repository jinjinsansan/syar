        ...
        <section style={card}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 12 }}>
            {([
              ...
              ['start-rear-fixed', '⑨ 発走直後（18.8%）— 芝からはみ出していたのを直した'],
              ['opening-side-high', '⑩ 位置取り（14.7%）— 真横のまま高い位置から'],
          ...
          <p style={{ ...note, margin: '10px 0 0' }}>
            ...
            ⚠️ ★⑨ の原因は ★<b>背景の作り方</b>でした。★真横のカットは 1 枚絵の板で描いており、
            ★板は走路を ★<b>水平の帯</b>として持ちます。★高い位置から見ると馬は斜めに並ぶので、
            ★先頭が芝の外に出ました。→ ★そのカットだけ ★<b>透視ワールド</b>へ回しています。
          </p>
