...
export function StoryShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="story-shell">
    ...
    <header className="story-header">
      <a href="/lp-preview" className="story-brand">馬物語<span>UMA MONOGATARI</span></a>
    ...
    <main id="story-content" className="story-content">
      <div className="story-breadcrumb"><a href="/lp-preview">馬物語</a><span aria-hidden="true">／</span><span>あなたの物語のつづき</span></div>
      {children}
    </main>
    <footer className="story-app-footer"><a className="story-brand" href="/lp-preview">馬物語<span>UMA MONOGATARI</span></a><p>育てる。走る。つながっていく。</p><a href="/login">ログイン</a><small>© 馬物語</small></footer>
  </div>;
}
