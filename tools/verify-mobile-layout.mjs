...
const PAGES = [
  ['/', '★TOP（馬物語）'],
  /**
   * ★**馬物語 UI の 9 画面**（★R-14・2026-09-17）。
   * ⚠️ ★ここに入れ忘れると ★**新しい画面が 1 度も測られません**。
   *    ★2026-09-17 時点で、★この一覧は旧画面しか持っていませんでした。
   *    → ★**画面を足したらここも足す**（★`story-shell.tsx` の `OWN_HEADER` と同じ約束）。
   */
  ['/home', '★ダッシュボード（馬物語）'],
  ['/howto', '★使い方（馬物語）'],
  ['/earn', '★ポイントを稼ぐ（馬物語）'],
  ['/watch-race', '★中継の入口（馬物語）'],
  ['/odds', '★オッズ（馬物語・次の 1 本へ送る）'],
  ['/odds/demo?demo=1', '★オッズ（馬物語・見本）'],
  ['/exchange', '★交換（馬物語）'],
  ['/mypage', '★わたしの馬（馬物語）'],
  ['/vote', '★投票（馬物語）'],
  ['/train', '★育成（馬物語）'],
  ['/design-check', '★デザイン確認の一覧'],
  ['/race', '★レース（キャンバス）'],
  ['/races', '★レース一覧'],
  ['/stable', '★厩舎'],
  ['/training', '★調教'],
