 ...
 */
/** ⚠️ ★画面の `WINNER_FOLLOW_SEC` と同じ値（★2026-09-13 に 2.4 → 1.6 へ短縮・R-31） */
export const AUDIT_WINNER_FOLLOW_SEC = 1.6;
/** ⚠️ ★画面の `RESULTS_BOARD_SEC` と同じ値（★2026-09-13 に 6 → 3 へ短縮・R-31） */
export const AUDIT_RESULTS_BOARD_SEC = 3;
