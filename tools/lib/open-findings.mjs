...
export const OPEN_FINDINGS = [
  ...
  {
    id: 'SEED-LOCKSTEP',
    what: '🔴 ★staging の現役 7,333 頭が ★**全頭 同じ `birth_week`（−160）** で、★育成サイクルが**足並みを揃えて**動く',
  ...
  },
  {
    ...
    why: '✔ ★**AU-1 で読み手を数えました**: ★`race-engine/src/coefficients.ts:151-152`。'
      ...
      + '→ ★**V-4 / V-5 / V-6 が動きます。★AL-11 の束で、全段階の前後を測ってから。**'
      + '⚠️ ★直す向きは ★**`CONDITION_MIN: 1 → 0`**（★育成を 1..5 に狭めるのは正典に反する）。'
      + '⚠️ ★**欠陥（0≡1）と食い違い（min=1 対 正典 0..5）は別**です。★前者は発火しており、★後者は確実に在ります',
    owner: 'dev',
    until: '2026-09-30',
  },
  {
