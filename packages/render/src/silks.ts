 ...
 *
 * 【🔴 ★育成の画面には出しません】（★2026-09-24・オーナー指摘）
 *   ★オーナー「★**そもそも育成ゲームモードで騎手はいませんので、出るわけないです。
 *   ★騎手は出走させる時に選ぶものです**」。
 *   ★裁定 §2 は「育成・厩舎でも本人の色を使う」でしたが、★**育成に騎手が居ない**以上、
 *   ★勝負服を出す場所ではありません。★`/train` から外しました。
 *   → ★勝負服が出るのは ★**出走・レース・厩舎の一覧**など、★騎手や枠が関わる場所です。
 *
 * 【★規則は 1 本】（★裁定 §2 条件 1）
